...
import 'package:vincent_flutter/view/login/style/LoginColors.dart';
import 'package:vincent_flutter/view/login/utils/BubbleIndicationPainter.dart';
...
class _LoginPageState extends State<LoginPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return StoreBuilder<VState>(builder: (BuildContext context, store) {
      return Scaffold(
        key: _scaffoldKey,
            ...
            child: Container(
              ...
              decoration: new BoxDecoration(
                gradient: new LinearGradient(
                    colors: [LoginColors.loginGradientStart, LoginColors.loginGradientEnd],
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: new Image(
                        width: 250.0, height: 191.0, fit: BoxFit.fill, image: AssetImage('assets/images/login_logo.png')),
                  ),
                  Padding(
                    ...
                    child: PageView(
                      ...
                      children: <Widget>[
                        new ConstrainedBox(
                          ...
                          child: _buildSignIn(context,store),
                        ),
                        new ConstrainedBox(
                          constraints: const BoxConstraints.expand(),
  ...
  void login(context,store) {
    String email = loginEmailController.text;
    String password = loginPasswordController.text;
    if (ObjectUtil.isEmpty(email)) {
      showInSnackBar("用户邮箱不能为空.");
    ...
    UserDao.login(email, password, "zh_CN", store).then((result) {
  ...
  Widget _buildSignIn(BuildContext context,store) {
    return Container(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: new BoxDecoration(
                  ...
                  gradient: new LinearGradient(
                      colors: [LoginColors.loginGradientEnd, LoginColors.loginGradientStart],
          ...
          Padding(
            ...
            child: FlatButton(
                ...
                child: Text(
                  "Forgot Password?",
                  style: TextStyle(
                      decoration: TextDecoration.underline, color: Colors.white, fontSize: 16.0, fontFamily: "WorkSansMedium"),
                )),
          ),
          Padding(
            padding: EdgeInsets.only(top: 10.0),
